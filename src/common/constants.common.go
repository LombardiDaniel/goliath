...
var (
	...
	S3Endpoint                        string = GetEnvVarDefault("S3_ENDPOINT", "https://br-se1.magaluobjects.com")
	S3Region                          string = GetEnvVarDefault("S3_REGION", "br-se1")
	S3Bucket                          string = GetEnvVarDefault("S3_BUCKET", ProjectName+"-gopherbase")
)
