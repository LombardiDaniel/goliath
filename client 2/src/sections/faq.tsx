...
export default function Faq() {
  return (
    <div>
      <section id="faq" className="dark:bg-darkBg bg-bg py-20 font-base lg:py-[100px] border-b-border dark:border-b-darkBorder border-b-2">
        ...
        <div className="mx-auto grid w-[700px] max-w-full px-5">
          <Accordion className="text-base sm:text-lg" type="single" collapsible>
            {Constants.FAQ.map((faq, i) => {
            return (
              <AccordionItem className="mb-2" value={faq.q} key={i}>
